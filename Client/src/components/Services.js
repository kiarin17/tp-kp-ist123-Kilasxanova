    ...
    <section className="services" id="services">
      ...
      <div className="services-cards">
        ...
        <div className="service-card">
          ...
          <p>
            Приобретите лучшую медовуху, сбитни, пряники и другие различные
            угощения. Доступна доставка.
          </p>
        </div>
        ...
        <div className="service-card">
          ...
          <p>
            Забронируйте столик в нашем уютном зале. Идеально для семейных
            торжеств и атмосферных встреч в духе старой России.
          </p>
        </div>
      </div>
    </section>
